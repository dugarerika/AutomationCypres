...
describe('Staging - Vendor Admin:COCOCUTSALON | Calendar| Appointment Checkout | logged with Admin Credentials', () => {
	beforeEach(() => {
...
describe('Staging - Vendor Admin:COCOCUTSALON | Calendar| Appointment Checkout | logged with Receptionist Credentials', () => {
	before(() => {
...
describe('Staging - Vendor Admin:COCOCUTSALON | Calendar| Appointment Checkout | logged with Staff Credentials', () => {
	before(() => {
		// ensure clean test slate for these tests
		cy.then(Cypress.session.clearAllSavedSessions);
	});
