...
context('Vendor Admin | logged with Staff credentials', () => {
  ...
  context('Vendor Admin | Calendar | Create appointments by Clicking on the calendar| logged with Staff credentials', () => {
...
context('Vendor Admin | logged with Receptionist credentials', () => {
  ...
  context('Vendor Admin | Calendar | Create appointment by Clicking on the calendar | logged with Receptionist credentials', () => {
  ...
  context.only('Vendor Admin | Staff/Staff Members| logged with Receptionist credentials', () => {
